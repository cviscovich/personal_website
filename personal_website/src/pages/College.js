...
// const soccer = window.open('http://wsoccervt.weebly.com/', '_blank');
            ...
            <div class="row" style={{ marginBottom: "2%" }}>
                    ...
                    <div class="nine columns">
                        ...
                        There is nothing that I love more than being a student at Virginia Tech. The main reason that
                         ...
                         I am the Co-President, Captain, and Social Media Representative of the 
                         Club Soccer Team at Virginia Tech, where we play
                        ...
                        <a class="button button-primary" href="http://wsoccervt.weebly.com/" target="_blank" rel="noopener noreferrer" style={{margin:"0px 5px 0px 0px", backgroundColor:colorV, borderColor:colorV}}>
                        <i class="fas fa-futbol"></i> Club Soccer Website</a>
                        <a class="button button-primary" href="https://www.ais.science.vt.edu/programs/cmda.html" target="_blank" rel="noopener noreferrer" style={{margin:"0px 5px 0px 0px", backgroundColor:colorI, borderColor:colorI}}> 
                        <i class="fas fa-university"></i> CMDA Website</a>
                        <a class="button button-primary" href="https://www.facebook.com/vtalphachi/" target="_blank" rel="noopener noreferrer" style={{margin:"0px 5px 0px 0px", backgroundColor:colorS, borderColor:colorS}}> 
